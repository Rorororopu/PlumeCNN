...
class Data(preliminary_processing.Datas):
    ...
    Arg:
        ...
        resolution: the resolution of interpolation. If not specified, you have to input it manually.
        paths: The complete list of file paths. If not specified, it is just [path].
